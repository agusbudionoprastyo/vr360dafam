...
CREATE TABLE IF NOT EXISTS `svt_users` (
  ...
  `id_customer_2checkout` varchar(50) DEFAULT NULL,
  `id_subscription_stripe` varchar(50) DEFAULT NULL,
  `id_subscription_paypal` varchar(50) DEFAULT NULL,
  `id_subscription_2checkout` varchar(50) DEFAULT NULL,
  ...
  `google_identifier` varchar(100) DEFAULT NULL,
  `facebook_identifier` varchar(100) DEFAULT NULL,
  `twitter_identifier` varchar(100) DEFAULT NULL,
  `wechat_identifier` varchar(100) DEFAULT NULL,
  `qq_identifier` varchar(100) DEFAULT NULL,
  `2fa_secretkey` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `svt_virtualtours` (
  ...
  `markers_icon_type` enum('round','square','round_outline','square_outline') DEFAULT 'round',
  ...
  `markers_default_sound` varchar(200) DEFAULT NULL,
  `markers_animation` varchar(50) NOT NULL DEFAULT 'none',
  `pois_icon` varchar(50) NOT NULL DEFAULT 'fas fa-info-circle',
  `pois_icon_type` enum('round','square','round_outline','square_outline') DEFAULT 'round',
  ...
  `pois_default_sound` varchar(200) DEFAULT NULL,
  ...
  `dollhouse` longtext,
  `dollhouse_glb` varchar(50) DEFAULT NULL,
  `password` varchar(200) DEFAULT NULL,
  ...
  `background_image_mobile` varchar(50) DEFAULT NULL,
  `background_video_mobile` varchar(50) DEFAULT NULL,
  ...
  `friendly_l_url` varchar(100) DEFAULT NULL,
  ...
  `poweredby_image` varchar(50) DEFAULT NULL,
  `poweredby_text` varchar(200) DEFAULT NULL,
  `poweredby_link` varchar(200) DEFAULT NULL,
  `show_location` tinyint(1) NOT NULL DEFAULT '0',
  `show_comments` tinyint(1) NOT NULL DEFAULT '0',
  `disqus_shortname` varchar(100) DEFAULT NULL,
  `disqus_public_key` varchar(200) DEFAULT NULL,
  ...
  `woocommerce_store_url` varchar(100) DEFAULT NULL,
  `woocommerce_store_cart` varchar(50) DEFAULT 'cart/',
  `woocommerce_store_checkout` varchar(50) DEFAULT 'checkout/',
  `woocommerce_customer_key` varchar(100) DEFAULT NULL,
  `woocommerce_customer_secret` varchar(100) DEFAULT NULL,
  ...
  `meta_title_l` varchar(100) DEFAULT NULL,
  `meta_description_l` text DEFAULT NULL,
  `meta_image_l` varchar(50) DEFAULT NULL,
  ...
  `mouse_follow_feedback` float NOT NULL DEFAULT '0.5',
...
CREATE TABLE IF NOT EXISTS `svt_pois` (
  ...
  `rotateZ` int(11) NOT NULL DEFAULT '0',
  `scale` tinyint(1) NOT NULL DEFAULT '0',
  `type` enum('image','video','link','link_ext','html','html_sc','download','form','video360','audio','gallery','google_maps','object360','embed','object3d','lottie','product','switch_pano','pdf','callout','pointclouds') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `svt_settings` (
  ...
  `license2` varchar(250) DEFAULT NULL,
  `name` varchar(200) DEFAULT 'Simple Virtual Tour',
  `theme_color` varchar(25) NOT NULL DEFAULT '#0b5394',
  `theme_color_dark` varchar(25) DEFAULT NULL,
  `dark_mode` tinyint(1) NOT NULL DEFAULT '1',
  `font_backend` varchar(50) DEFAULT 'Nunito',
  `sidebar` enum('gradient','flat') DEFAULT 'gradient',
  `sidebar_color1` varchar(25) DEFAULT NULL,
  `sidebar_color2` varchar(25) DEFAULT NULL,
  `sidebar_color1_dark` varchar(25) DEFAULT NULL,
  `sidebar_color2_dark` varchar(25) DEFAULT NULL,
  `logo` varchar(50) DEFAULT NULL,
  ...
  `2checkout_merchant` varchar(200) DEFAULT NULL,
  `2checkout_secret` varchar(200) DEFAULT NULL,
  ...
  `social_wechat_id` varchar(200) DEFAULT NULL,
  `social_wechat_secret` varchar(200) DEFAULT NULL,
  `social_qq_id` varchar(200) DEFAULT NULL,
  `social_qq_secret` varchar(200) DEFAULT NULL,
  ...
  `share_providers` varchar(250) NOT NULL DEFAULT 'email,whatsapp,facebook,twitter,linkedin,telegram,facebook_messenger,pinterest,reddit,line,viber,vk,qzone,wechat',
  `disqus_shortname` varchar(100) DEFAULT NULL,
  `disqus_public_key` varchar(200) DEFAULT NULL,
  ...
  `aws_s3_type` enum('aws','r2','digitalocean') DEFAULT 'aws',
  `aws_s3_vt_auto` tinyint(1) NOT NULL DEFAULT '0',
  `aws_s3_accountid` varchar(50) DEFAULT NULL,
  `aws_s3_custom_domain` varchar(50) DEFAULT NULL,
  `aws_s3_region` varchar(50) DEFAULT NULL,
  `aws_s3_key` varchar(200) DEFAULT NULL,
  `aws_s3_secret` varchar(200) DEFAULT NULL,
  `aws_s3_bucket` varchar(200) DEFAULT NULL,
  `globe_ion_token` varchar(200) DEFAULT NULL,
  `globe_arcgis_token` varchar(200) DEFAULT NULL,
  `globe_googlemaps_key` varchar(200) DEFAULT NULL,
  `ai_key` varchar(200) DEFAULT NULL,
  `deepl_api_key` varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `svt_showcases` (
  ...
  `meta_image` varchar(50) DEFAULT NULL,
  `show_in_first_page` tinyint(1) NOT NULL DEFAULT '0',
  `sort_settings` text DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_user` (`id_user`),
