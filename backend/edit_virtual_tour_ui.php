                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input oninput="change_custom_title();" onchange="change_custom_title();" id="custom_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['custom']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label><?php echo _("Content - Html / Link"); ?></label>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="custom2_title"><?php echo _("Title"); ?></label>
                                                <input oninput="change_custom2_title();" onchange="change_custom2_title();" id="custom2_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['custom2']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label><?php echo _("Content - Html / Link"); ?></label>
                                            <div id="custom2_content_html"><?php echo htmlentities($virtual_tour['custom2_content']); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="custom3_title"><?php echo _("Title"); ?></label>
                                                <input oninput="change_custom3_title();" onchange="change_custom3_title();" id="custom3_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['custom3']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label><?php echo _("Content - Html / Link"); ?></label>
                                            <div id="custom3_content_html"><?php echo htmlentities($virtual_tour['custom3_content']); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="custom4_title"><?php echo _("Title"); ?></label>
                                                <input oninput="change_custom4_title();" onchange="change_custom4_title();" id="custom4_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['custom4']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label><?php echo _("Content - Html / Link"); ?></label>
                                            <div id="custom4_content_html"><?php echo htmlentities($virtual_tour['custom4_content']); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="custom5_title"><?php echo _("Title"); ?></label>
                                                <input oninput="change_custom5_title();" onchange="change_custom5_title();" id="custom5_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['custom5']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label><?php echo _("Content - Html / Link"); ?></label>
                                            <div id="custom5_content_html"><?php echo htmlentities($virtual_tour['custom5_content']); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="location_title"><?php echo _("Title"); ?></label>
                                                <input oninput="change_location_title();" onchange="change_location_title();" id="location_title" type="text" class="form-control form-control-sm" value="<?php echo $ui_style['controls']['location']['label']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <?php
                                            ...
                                            <div style="margin-bottom: 5px;" class="form-group">
                                                <label><?php echo _("Map Embed Code / Link"); ?></label>
                                                <textarea rows="4" id="gm_map" class="form-control"><?php echo $location_content_split[0]; ?></textarea>
                                            </div>
                                            <div style="margin-bottom: 5px;" class="form-group">
                                                <label><?php echo _("Street View Embed Code / Link"); ?></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="marker_icon_and_room" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==1) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['markers_animation']; ?> custom-hotspot noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="marker_room_and_icon" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==2) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['markers_animation']; ?> custom-hotspot noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                        <div class="div_marker_wrapper div_marker_wrapper_bg" style="background-color: <?php echo $virtual_tour['markers_background']; ?>;<?php echo $markers_style_icon_type; ?>">
                                                            <span style="vertical-align: middle; color: <?php echo $virtual_tour['markers_color']; ?>;"><?php echo _('ROOM NAME'); ?>&nbsp;</span>
                                                            <i class="<?php echo $virtual_tour['markers_icon']; ?>" style="margin: 0px auto; vertical-align: middle; font-size: 24px; color: <?php echo $virtual_tour['markers_color']; ?>;"></i>
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="marker_only_icon" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==0) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['markers_animation']; ?> custom-hotspot noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:41px;margin:0 auto;">
                                                        <div class="div_marker_wrapper div_marker_wrapper_bg" style="background-color: <?php echo $virtual_tour['markers_background']; ?>;<?php echo $markers_style_icon_type; ?>">
                                                            <i class="<?php echo $virtual_tour['markers_icon']; ?>" style="margin: 0px auto; vertical-align: middle; font-size: 24px; color: <?php echo $virtual_tour['markers_color']; ?>;"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style="background:lightgray;padding:5px;" id="marker_only_room" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==3) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['markers_animation']; ?> custom-hotspot noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                        <div class="div_marker_wrapper div_marker_wrapper_bg" style="background-color: <?php echo $virtual_tour['markers_background']; ?>;<?php echo $markers_style_icon_type; ?>">
                                                            <span style="vertical-align: middle; color: <?php echo $virtual_tour['markers_color']; ?>;"><?php echo _('ROOM NAME'); ?></span>
                                                        </div>
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="marker_custom_icon" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==4) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['markers_animation']; ?> custom-hotspot noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="marker_preview_room" class="marker_final_preview <?php echo ($virtual_tour['markers_show_room']==5) ? '' : 'd-none' ;  ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="poi_icon_and_label" class="poi_final_preview <?php echo ($virtual_tour['pois_style']==2) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['pois_animation']; ?> custom-hotspot-content noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="poi_label_and_icon" class="poi_final_preview <?php echo ($virtual_tour['pois_style']==3) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['pois_animation']; ?> custom-hotspot-content noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                        <div class="div_poi_wrapper div_poi_wrapper_bg" style="background-color: <?php echo $virtual_tour['pois_background']; ?>;<?php echo $pois_style_icon_type; ?>">
                                                            <span style="vertical-align: middle; color: <?php echo $virtual_tour['pois_color']; ?>;"><?php echo _('POI LABEL'); ?>&nbsp;</span>
                                                            <i class="<?php echo $virtual_tour['pois_icon']; ?>" style="margin: 0px auto; vertical-align: middle; font-size: 24px; color: <?php echo $virtual_tour['pois_color']; ?>;"></i>
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="poi_only_icon" class="poi_final_preview <?php echo ($virtual_tour['pois_style']==0) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['pois_animation']; ?> custom-hotspot-content noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:41px;margin:0 auto;">
                                                        <div class="div_poi_wrapper div_poi_wrapper_bg" style="background-color: <?php echo $virtual_tour['pois_background']; ?>;<?php echo $pois_style_icon_type; ?>">
                                                            <i class="<?php echo $virtual_tour['pois_icon']; ?>" style="margin: 0px auto; vertical-align: middle; font-size: 24px; color: <?php echo $virtual_tour['pois_color']; ?>;"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style="background:lightgray;padding:5px;" id="poi_only_label" class="poi_final_preview <?php echo ($virtual_tour['pois_style']==4) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['pois_animation']; ?> custom-hotspot-content noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                                        <div class="div_poi_wrapper div_poi_wrapper_bg" style="background-color: <?php echo $virtual_tour['pois_background']; ?>;<?php echo $pois_style_icon_type; ?>">
                                                            <span style="vertical-align: middle; color: <?php echo $virtual_tour['pois_color']; ?>;"><?php echo _('POI LABEL'); ?></span>
                                                        </div>
                                                ...
                                                <div style="background:lightgray;padding:5px;" id="poi_custom_icon" class="poi_final_preview <?php echo ($virtual_tour['pois_style']==1) ? '' : 'd-none' ;  ?>">
                                                    <div class="pnlm-hotspot-base animate__animated animate__slow animate__infinite animate__<?php echo $virtual_tour['pois_animation']; ?> custom-hotspot-content noselect pnlm-pointer" draggable="false" style="visibility:visible;position:relative;cursor:default;width:fit-content;margin:0 auto;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" id="apply_marker_default_sound" checked />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="apply_marker_default_scale"><?php echo _("Scale"); ?></label><br>
                                                <input type="checkbox" id="apply_marker_default_scale" checked />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" id="apply_poi_default_sound" checked />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="apply_poi_default_scale"><?php echo _("Scale"); ?></label><br>
                                                <input type="checkbox" id="apply_poi_default_scale" checked />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select <?php echo (!$plan_permissions['enable_multilanguage']) ? 'disabled' : '' ; ?> onchange="save_vt_ui(false,false,false);" style="height: 125px" multiple class="form-control selectpicker" id="languages_enabled" data-actions-box="true" data-selected-text-format="count > 3" data-count-selected-text="{0} <?php echo _("items selected"); ?>" data-deselect-all-text="<?php echo _("Deselect All"); ?>" data-select-all-text="<?php echo _("Select All"); ?>" data-none-selected-text="<?php echo _("Only default language"); ?>" data-none-results-text="<?php echo _("No results matched"); ?> {0}">
                ...
                <div id="ui_edit_audio" class="ui_edit_box noselect">
                    ...
                    <div class="ui_content_box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="song_bg_volume"><?php echo _("Volume"); ?></label>
                                    <input min="0" max="1" step="0.1" id="song_bg_volume" type="range" class="form-control-range" value="<?php echo $virtual_tour['song_bg_volume']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-12">
                                ...
                                <select onchange="save_vt_ui(false,false,false);" <?php echo (!$plan_permissions['enable_share']) ? 'disabled' : '' ; ?> id="share_providers" data-iconBase="fa" data-tickIcon="fa-check" data-actions-box="true" data-selected-text-format="count > 8" data-count-selected-text="{0} <?php echo _("items selected"); ?>" data-deselect-all-text="<?php echo _("Deselect All"); ?>" data-select-all-text="<?php echo _("Select All"); ?>" data-none-selected-text="<?php echo _("Nothing selected"); ?>" data-none-results-text="<?php echo _("No results matched"); ?> {0}" class="form-control selectpicker" multiple>
                                    ...
                                    <?php if(in_array('twitter',$array_share_providers_settings)) : ?><option data-icon="fab fa-twitter" id="provider_twitter" <?php echo (in_array('twitter',$array_share_providers) ? 'selected' : ''); ?>><?php echo _("Twitter"); ?></option><?php endif; ?>
...
<script>
    (function($) {
        ...
        $(document).ready(function () {
            ...
            window.custom2_content_html = ace.edit('custom2_content_html');
            ...
            window.custom3_content_html = ace.edit('custom3_content_html');
            ...
            window.custom4_content_html = ace.edit('custom4_content_html');
            ...
            window.custom5_content_html = ace.edit('custom5_content_html');
